...
typedef struct {
    ...
    /* 0x0004 */ uint32_t partition_lba;
    /* 0x0008 */ uint32_t partition_sectors;
    /* 0x000C */ uint32_t bytes_per_sector;
    /* 0x0010 */ uint32_t sectors_per_cluster;
    /* 0x0014 */ uint32_t reserved_sectors;
    /* 0x0018 */ uint32_t number_of_fat;
    /* 0x001C */ uint16_t entry_cnt;
    /* 0x0020 */ uint32_t fs_sector_cnt;
    /* 0x0024 */ uint32_t fat_sector_cnt;
    /* 0x0028 */ uint32_t root_cluster;
    /* 0x002C */ uint32_t fsis_lba;
    /* 0x0030 */ uint32_t fat_lba;
    /* 0x0034 */ uint32_t root_lba;
    /* 0x0038 */ uint32_t data_lba;
    /* 0x003C */ uint32_t bytes_per_cluster;
    /* 0x0040 */ uint32_t max_cluster;
    /* 0x0044 */ uint32_t blocks_free;
    /* 0x0048 */ fat_cache_t cache[FAT_CACHE_MAX];
} fat_ctxt_t;
