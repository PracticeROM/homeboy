...
void* list_at(const struct list* list, size_t position) {
    ...
    struct list_element_header* header = (struct list_element_header*)((char*)list->first - ELEMENT_HEADER_SIZE);
...
void* list_insert_size(struct list* list, void* element, size_t size, const void* data) {
    ...
    if (element) {
        struct list_element_header* header = (struct list_element_header*)((char*)element - ELEMENT_HEADER_SIZE);
        ...
        if (list->size == 0) {
            ...
            new_header->prev = (struct list_element_header*)((char*)list->last - ELEMENT_HEADER_SIZE);
...
void list_transfer(struct list* dest, void* position, struct list* src, void* element) {
    struct list_element_header* e_header = (struct list_element_header*)((char*)element - ELEMENT_HEADER_SIZE);
    ...
    if (position) {
        struct list_element_header* p_header = (struct list_element_header*)((char*)position - ELEMENT_HEADER_SIZE);
        ...
        if (dest->size == 0) {
            ...
            e_header->prev = (struct list_element_header*)((char*)dest->last - ELEMENT_HEADER_SIZE);
...
void list_splice(struct list* dest, struct list* src) {
    ...
    dest->size += src->size;
    if (dest->last) {
        struct list_element_header* f_header = (struct list_element_header*)((char*)src->first - ELEMENT_HEADER_SIZE);
        struct list_element_header* l_header = (struct list_element_header*)((char*)dest->last - ELEMENT_HEADER_SIZE);
...
void* list_insert_after_size(struct list* list, void* element, size_t size, const void* data) {
...
void* list_insert_after(struct list* list, void* element, const void* data) {
    return list_insert_size(list, list_next_in(list, element), list->element_size, data);
}
...
void list_destroy(struct list* list) {
    ...
    if (list->first) {
        header = (struct list_element_header*)((char*)list->first - ELEMENT_HEADER_SIZE);
    }
    while (header) {
